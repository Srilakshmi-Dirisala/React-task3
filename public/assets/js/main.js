(function ($) {
  ...
  */
  ...
  popupSarchBox('.claim-giveaways', '.claimGiveaways', '.searchClose', 'show');
  popupSarchBox('.check-whitelisted', '.checkWhitelisted', '.searchClose', 'show');
...
$(document).ready(function () {
  $('.popup-search-box select').selectize({
      sortField: 'text'
  });
});